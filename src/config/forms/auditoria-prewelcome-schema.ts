...
export const auditoriaPrewelcomeSchema = z.object({
  ...
  fecha_liberacion_pyme: z.string().min(1, "Campo obligatorio"),
  ...
  fecha_liberacion: z.string().min(1, "Campo obligatorio"),
  codigo_gestion: z.string().min(1, "Campo obligatorio"),
  observacion: z.string().min(1, "Campo obligatorio"),
  observacion_pyme: z.string().min(1, "Campo obligatorio"),
});
