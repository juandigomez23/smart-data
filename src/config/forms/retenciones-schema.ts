...
export const retencionesSchema = z.object({
  ...
  descuento_otorgado: z.string().regex(/^\d+$/, "Solo números").min(1, "Campo obligatorio"),
  meses_descuento: z.string().regex(/^\d+$/, "Solo números").min(1, "Campo obligatorio"),
  ...
  linea_principal: z.string().regex(/^\d+$/, "Solo números").min(1, "Campo obligatorio"),
  ...
  linea_principal_no_acepta: z.string().regex(/^\d+$/, "Solo números").min(1, "Campo obligatorio"),
  ...
  descuentos_escalonados_info: z.string().min(1, "Campo obligatorio"),
  cambio_plan_info: z.string().min(1, "Campo obligatorio"),
  no_acepta_info: z.string().min(1, "Campo obligatorio"),
  cierre_llamada_info: z.string().min(1, "Campo obligatorio"),
  cierre_llamada_info_no_acepta: z.string().min(1, "Campo obligatorio"),
  resultado_gestion_info: z.string().min(1, "Campo obligatorio"),
  debito_automatico_info: z.string().min(1, "Campo obligatorio"),
});
