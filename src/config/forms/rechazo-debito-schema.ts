...
export const rechazoDebitoSchema = z.object({
  ...
  numero_telefonico_peru: z.string().min(1, "Teléfono (Perú) obligatorio"),
  ...
  fecha_acuerdo_pago_peru: z.string().min(1, "Fecha acuerdo (Perú) obligatoria"),
  ...
  numero_telefonico_ecuador: z.string().min(1, "Teléfono (Ecuador) obligatorio"),
  ...
  fecha_acuerdo_pago_ecuador: z.string().min(1, "Fecha acuerdo (Ecuador) obligatoria"),
  ...
  numero_telefonico_colombia: z.string().min(1, "Teléfono (Colombia) obligatorio"),
  ...
  fecha_acuerdo_pago_colombia: z.string().min(1, "Fecha acuerdo (Colombia) obligatoria"),
  ...
  numero_telefonico: z.string().min(1, "Teléfono obligatorio"),
  ...
  fecha_acuerdo_pago: z.string().min(1, "Fecha acuerdo obligatoria"),
